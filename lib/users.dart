...
class Users {
  static get initUsers => <User>[
    ...
    User(
      ...
      lastMessageTime: DateTime.now(), idUser: '3',
    ),
    User(
      ...
      lastMessageTime: DateTime.now(), idUser: '4',
    ),
    User(
      name: 'Caren Black',
      urlAvatar:
      ...
      lastMessageTime: DateTime.now(), idUser: '5',
    ),
    User(
      name: 'Tim White',
      urlAvatar:
      ...
      lastMessageTime: DateTime.now(), idUser: '6',
    ),
    User(
      ...
      lastMessageTime: DateTime.now(), idUser: '7',
    ),
    User(
      name: 'Sarah Field',
      urlAvatar:
      ...
      lastMessageTime: DateTime.now(),idUser: '8' ,
    ),
    User(
      ...
      lastMessageTime: DateTime.now(), idUser: '9',
    ),
    User(
      name: 'James Schmidt',
      urlAvatar:
      ...
      lastMessageTime: DateTime.now(), idUser: '10',
    ),
    User(
      name: 'Anton Wagner',
      urlAvatar:
      ...
      lastMessageTime: DateTime.now(), idUser: '11',
    ),
  ];
}